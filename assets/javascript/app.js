...
var questions = [
    new Question("What is the name of Liverpools stadium?", ["Stamford Bridge", "Emerites Stadium", "Anfield", "Camp Nou"], "Anfield"),
    new Question("How many times have Liverpool won the UEFA Champions League?", ["2", "5", "7", "1"], "5"),
    new Question("Which club is Liverpools biggest rival?"["Manchester United", "Chelsea", "Manchester City", "Arsenal"], "Manchester United"),
    ...
    new Question("Who scores the fastest hat trick in a Liverpool kit ever, and how fast was it?" ["Sadio Mane, 2min 56sec", "Robbie Fowler, 4min 33sec", "Mark Walters, 10min 33sec", "Peter Crouch, 6min 2sec"], "Robbie Fowler, 4min 33sec"),
    ...
    new Question("Who was the longest serving manager all time for Liverpool?", ["Tom Watson", "Roy Evans", "Ron Yeats", "Kenny Dalglish"], "Tom Watson"),
